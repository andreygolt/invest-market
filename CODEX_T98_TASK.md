# T98 — Светлая тема: каталог, dashboard, deal room + горизонтальный фильтр

## Контекст

T91–T97 не были выполнены (usage limit). Это повтор задачи T97.
...
7. Записать в progress.md: `DONE: T98` + что создано/изменено
