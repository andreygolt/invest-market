# T96 — Светлая тема: каталог, dashboard, deal room + горизонтальный фильтр

## Контекст

T91, T92, T93, T94, T95 не были выполнены (usage limit). Это повтор задачи T95.
...
7. Записать в progress.md: `DONE: T96` + что создано/изменено
