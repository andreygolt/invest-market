# T99 — Светлая тема: каталог, dashboard, deal room + горизонтальный фильтр

## Контекст

T91–T98 не были выполнены (usage limit). Это повтор задачи T98.
...
7. Записать в progress.md: `DONE: T99` + что создано/изменено
