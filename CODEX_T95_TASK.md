# T95 — Светлая тема: каталог, dashboard, deal room + горизонтальный фильтр

## Контекст

T91, T92, T93, T94 не были выполнены (usage limit). Это повтор задачи T94.
...
7. Записать в progress.md: `DONE: T95` + что создано/изменено
